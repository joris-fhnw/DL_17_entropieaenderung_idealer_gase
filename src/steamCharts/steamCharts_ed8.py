...
class SteamCharts:
    ...
    #     plt.semilogx(1 / PropsSI("D", "P", self.p, "T", Temps, "HEOS::Water"), Temps,
    #                  label='Pressure = ' + str(self.p / 1e5) + ' bar, ')
    ...
    #     plt.semilogx(1 / PropsSI("D", "P", Press, "T", self.T, "HEOS::Water"), Press / 1e5,
    ...
    #     fig = plt.figure()
    #     # plotting the isotherm in P_v diagram
    #     plt.loglog(1 / PropsSI("D", "P", Press, "T", self.T, "HEOS::Water"), Press / 1e5,
    #                label='Temperature = ' + str(self.T) + ' K, ')
    #     if self.saturated == 'False':
    ...
    #     plt.plot(PropsSI("Smass", "P", self.p, "T", Temps, "HEOS::Water"), Temps,
    #              label='Pressure = ' + str(self.p / 1e5) + ' bar, ')
    #     if self.saturated == 'False':
